...
public class FilmAdapter extends BaseAdapter {
    ...
    private class ViewHolder {
        ...
        private TextView txtPemain;
        private TextView txtKreator;
        ...
        ViewHolder(View view) {
            ...
            txtPemain = view.findViewById(R.id.txt_pemain);
            txtKreator = view.findViewById(R.id.txt_kreator);
        ...
        void bind(Film films) {
            ...
            txtPemain.setText(films.getPemain());
            txtKreator.setText(films.getKreator());
