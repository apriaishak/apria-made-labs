...
public class MainActivity extends AppCompatActivity {
    ...
    private String[] dataPemain;
    private String[] dataKreator;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> adapterView, View view, int i, long l) {
                ...
                film.setPemain(films.get(i).getPemain());
                film.setKreator(films.get(i).getKreator());
    ...
    private void prepare() {
        ...
        dataPemain = getResources().getStringArray(R.array.data_pemain);
        dataKreator = getResources().getStringArray(R.array.data_kreator);
    ...
    private void addItem() {
        ...
        for (int i = 0; i < dataJudul.length; i++) {
            ...
            film.setPemain(dataPemain[i]);
            film.setKreator(dataKreator[i]);
